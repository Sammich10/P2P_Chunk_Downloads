...
cat tests/wait10.txt tests/test6.txt tests/test1.txt tests/exit.txt | ./peernode.o peer_configs/peer3.cfg > logs/peer3.log &

cat tests/wait10.txt tests/test7.txt tests/test2.txt tests/exit.txt | ./peernode.o peer_configs/peer4.cfg > logs/peer4.log &

cat tests/wait10.txt tests/test1.txt tests/test3.txt tests/exit.txt | ./peernode.o peer_configs/peer5.cfg > logs/peer5.log &
